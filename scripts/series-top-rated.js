...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const prevButton = document.querySelector(".swiper-button-prev-top-rated-series");
    const nextButton = document.querySelector(".swiper-button-next-top-rated-series");
